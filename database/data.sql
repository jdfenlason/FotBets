...
values ('admin', '$argon2i$v=19$m=4096,t=3,p=1$hGbWC2fc6DqqoK+hxRoEcg$C7GxIzxuWHI3RPt/b4ThE+umNnsYLqqlaY1iG12p69A', 1000),
      ('guest', '$argon2i$v=19$m=4096,t=3,p=1$a8x1BOENLgPWi0SReB7zNg$Br+t7vjWyG2splBT2TA45xzpMKv/HM+kyePvQBt0/As', 2000),
...
values ('2', '695768', '100', '400', '3987', 'https://media.api-sports.io/football/teams/9030.png', 'false', '2021-17-07', '2021-07-15T15:24:18.178884Z', 'false' )
